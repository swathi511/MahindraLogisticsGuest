...
public class DrawerItemCustomAdapter extends ArrayAdapter<NavigationData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageViewIcon = (ImageView) listItem.findViewById(com.hjsoftware.mahindralogisticsguest.R.id.imageViewIcon);
        TextView textViewName = (TextView) listItem.findViewById(com.hjsoftware.mahindralogisticsguest.R.id.textViewName);
        ...
        {
            textViewName.setTextColor(Color.parseColor("#ed1c25"));
