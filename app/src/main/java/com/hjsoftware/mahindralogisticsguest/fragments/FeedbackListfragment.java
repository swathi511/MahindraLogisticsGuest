...
public class FeedbackListfragment extends Fragment {
    ...
    View v;
    FeedbackRecyclerAdapter bAdapter;
    RecyclerView rView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v=inflater.inflate(R.layout.fragment_feedback_list, container, false);
    ...
    public void getData()
    {
        ...
        Call<List<DutyDataPojo>> call=REST_CLIENT.getFeedbackBoookings(profileid);
            ...
            public void onResponse(Call<List<DutyDataPojo>> call, Response<List<DutyDataPojo>> response) {
                ...
                if(response.isSuccessful())
                {
                    ...
                    if(aList.size()!=0)
                    {
                        ...
                        bAdapter = new FeedbackRecyclerAdapter(getActivity(), aList);
