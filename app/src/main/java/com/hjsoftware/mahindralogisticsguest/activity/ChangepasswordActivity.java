...
import com.hjsoftware.mahindralogisticsguest.fragments.ChangePasswordFragment;
...
public class ChangepasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().add(R.id.content_frame, fragment,"Change Password").commit();
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                Intent i=new Intent(ChangepasswordActivity.this,BookingListActivity.class);
                ...
                break;
            case 2:
                Intent m=new Intent(ChangepasswordActivity.this,TrackBookingActivity.class);
                ...
                break;
            case 3:
                Intent o=new Intent(ChangepasswordActivity.this,FeedbackListActivity.class);
                ...
                break;
            case 4:
                Intent j=new Intent(ChangepasswordActivity.this,ChangepasswordActivity.class);
