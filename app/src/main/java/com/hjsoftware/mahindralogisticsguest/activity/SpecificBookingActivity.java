...
import com.hjsoftware.mahindralogisticsguest.NewBookingFragment;
...
public class SpecificBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment=new NewBookingFragment();
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                Intent k=new Intent(SpecificBookingActivity.this,HomeActivity.class);
                ...
                break;
            case 1:
                Intent i=new Intent(SpecificBookingActivity.this,BookingListActivity.class);
                ...
                break;
//            case 2:
//                Intent m=new Intent(BookingListActivity.this,DutySlipActivity.class);
...
//                break;
            case 2:
                Intent j=new Intent(SpecificBookingActivity.this,ChangepasswordActivity.class);
