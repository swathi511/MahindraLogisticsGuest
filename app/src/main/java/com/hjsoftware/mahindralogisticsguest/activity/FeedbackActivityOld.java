...
public class FeedbackActivityOld extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().add(R.id.content_frame, fragment,"Edit Bookings").commit();
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                Intent k=new Intent(FeedbackActivityOld.this,HomeActivity.class);
                ...
                break;
            case 1:
                Intent i=new Intent(FeedbackActivityOld.this,BookingListActivity.class);
                ...
                break;
            case 2:
                Intent m=new Intent(FeedbackActivityOld.this,TrackBookingActivity.class);
                ...
                break;
            case 3:
                Intent o=new Intent(FeedbackActivityOld.this,FeedbackListActivity.class);
                ...
                break;
            case 4:
                Intent j=new Intent(FeedbackActivityOld.this,ChangepasswordActivity.class);
