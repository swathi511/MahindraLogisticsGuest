...
import com.hjsoftware.mahindralogisticsguest.FeedbackRecyclerAdapter;
import com.hjsoftware.mahindralogisticsguest.SessionManager;
import com.hjsoftware.mahindralogisticsguest.fragments.FeedbackListfragment;
...
public class FeedbackListActivity extends AppCompatActivity implements FeedbackRecyclerAdapter.AdapterCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment=new FeedbackListfragment();
    ...
    public void onMethodCallback(int position, ArrayList<DutyData> data) {
        ...
        Intent i=new Intent(FeedbackListActivity.this,FeedbackActivity.class);
        i.putExtra("dslipno", dd.getDsno());
        i.putExtra("dslipid", dd.getDslipid());
        startActivity(i);
        //finish();
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                Intent k=new Intent(FeedbackListActivity.this,HomeActivity.class);
                ...
                break;
            case 1:
                Intent i=new Intent(FeedbackListActivity.this,BookingListActivity.class);
                ...
                break;
            case 2:
                Intent m=new Intent(FeedbackListActivity.this,TrackBookingActivity.class);
                ...
                break;
            case 3:
                Intent o=new Intent(FeedbackListActivity.this,FeedbackListActivity.class);
                ...
                break;
            case 4:
                Intent j=new Intent(FeedbackListActivity.this,ChangepasswordActivity.class);
            ...
            case REQUEST_LOCATION:
                ...
                switch (resultCode) {
                    case Activity.RESULT_OK: {
                        ...
                        Toast.makeText(FeedbackListActivity.this, "Please wait.. Getting Location!", Toast.LENGTH_LONG).show();
                       /* if(sbMsg!=null) {
                            sbMsg.dismiss();
                        }*/
                        break;
                    ...
                    case Activity.RESULT_CANCELED: {
                        Toast.makeText(FeedbackListActivity.this, "GPS should be enabled for the app to run!", Toast.LENGTH_LONG).show();
                        finish();
                        break;
                    }
                    default: {
